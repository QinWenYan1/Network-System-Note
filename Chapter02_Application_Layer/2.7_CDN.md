...
* [*知识点14: CDN部署策略-Enter Deep*](#id14)
* [*知识点15: CDN部署策略-Bring Home*](#id15)
...
**注意点**
* 📋 **术语**：CBR (Constant Bit Rate) - 恒定比特率、VBR (Variable Bit Rate) - 可变比特率、MPEG - 运动图像专家组
...
3. netcinema的权威DNS返回URL：`http://KingCDN.com/NetC6y&B23V`
...
```
                    0. upload copies
        Amazon      of multiple        Akamai
        cloud       versions of video  CDN
                  to CDNs
    
Netflix
registration,         3. Manifest file
accounting            returned for     Limelight
servers     2. Bob browses requested   CDN
                       video 2
            1. Bob manages
            Netflix account                Level-3 CDN
                                                 4. DASH
                                                 streaming
```
