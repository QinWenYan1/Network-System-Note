...
* [*知识点3: DNS(Domain Name System)的历史*](#id3)
* [*知识点4: DNS总体思路和目标*](#id4)
...
| 问题 | 解决方案 |
|------|----------|
| **问题1：如何命名设备** | 用**有意义的字符串**：好记，便于人类使用<br>解决一个平面命名的重名问题：**层次化命名** |
...
<a id="id3"></a>
## ✅ 知识点3: DNS(Domain Name System)的历史
...
**注意点**
* 💡 DNS在**应用层**实现，但提供**核心网络功能**
* 📋 **术语**：UDP端口53、Host aliasing、Mail server aliasing、Load Distribution
...
**注意点**
* 📋 **术语**：Zone - 区域、Authoritative Record - 权威记录
...
* **功能**：提供组织机构服务器（如Web和mail）可访问的**主机和IP之间的映射**
...
**注意点**
* 📋 **术语**：RR (Resource Record) - 资源记录、TTL (Time To Live) - 生存时间、CNAME (Canonical Name) - 规范名字、MX (Mail Exchange) - 邮件交换、NS (Name Server) - 名字服务器
