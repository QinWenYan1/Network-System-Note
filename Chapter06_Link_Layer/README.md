...
**下一章（第7章）**：
- 无线网络与移动网络(`Wireless and Mobile Networks`)——深入探讨无线链路特性、802.11细节、蜂窝网络架构、移动IP与切换管理
- 涉及的关键概念：无线链路特征（高误码率、隐藏终端）、CDMA码分多址、WiMAX、移动性管理(`Mobility Management`)、间接路由与直接路由
